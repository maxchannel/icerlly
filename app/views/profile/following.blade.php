                    ...
                    <div class="panel panel-default post " ng-app="IcerllyApp">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <p class="post-content"><a href="{{ route('profile', [$following->following->username]) }}"><img src="{{ asset('images/avatar/'.$following->following->avatar->name) }}" class="post-avatar-indie" /></a> <a href="{{ route('profile', [$following->following->username]) }}">{{{ $following->following->full_name }}}</a></p>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                </div>
                            </div>

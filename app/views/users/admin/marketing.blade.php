        ...
        <div class="row">
            ...
            <div class="col-md-8" ng-app="IcerllyApp">
                ...
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <li role="presentation" class="active"><a href="{{ route('admin_marketing') }}">Marketing</a></li>
                </ul></br>
                ...
                <h3>Marketing Emaling:</h3>

                {{ Form::open(['route'=>'admin_marketing_send', 'method'=>'POST', 'role'=>'form']) }}
